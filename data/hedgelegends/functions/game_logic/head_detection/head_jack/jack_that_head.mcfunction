...
execute if entity @s[tag=HLimeLTurnin] run scoreboard players remove $limeteam teamscores 1
...
execute if entity @s[tag=HLimeLTurnin] run title @a actionbar [{"text":"Creeper's","color":"green"},{"text":" head has been jacked!","color":"red"}]
